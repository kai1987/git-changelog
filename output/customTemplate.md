...
## Bug Fixes
  ...
  - **git log**
    - Ignores letter case (d4cff0a86c5ce46405f3c0dd03f9c49a7d620792, Closes: [#54](git@github.com:kai1987/git-changelog/issues/54))
  - **git tag**
  ...
  - **git_changelog_generate**
    - pass tag if it exists to gitReadLog (7c801927672792fc9a818653b74c78d77c7bff9e, Closes: [#5](git@github.com:kai1987/git-changelog/issues/5))
  - **nested lists**
    - nested list fix. Closes #9 (2285551810919bd4d8a749ae3ddd88f9cedcdd0e, Closes: [#9](git@github.com:kai1987/git-changelog/issues/9))
  - **options**
  ...
  - **template**
    - Fixes missing space in version_name output in template (f494f4a93a3c4a245f706cfb65f735a5ccccb2ce, Closes: [#72](git@github.com:kai1987/git-changelog/issues/72))
  - **travis**
